  ...
  if (!ScriptExecution) {
    return (
      <div className="text-center py-20">
        ...
        <Link to="/ScriptExecutions" className="mt-4 inline-flex items-center gap-2 text-primary hover:underline">
    ...
    <div className="space-y-8">
      ...
      <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-6">
        <div className="space-y-2">
          <Link to="/ScriptExecutions" className="inline-flex items-center gap-2 text-sm font-semibold text-slate-500 dark:text-slate-400 hover:text-primary transition mb-2">
      ...
      {isScriptExecutionActive && (
        <div className="p-6 bg-card border border-blue-200 dark:border-blue-900/40 rounded-xl space-y-4">
          ...
          <div className="w-full bg-muted h-2.5 rounded-full overflow-hidden">
            <div className="bg-info/100 h-full transition-all duration-500" style={{ width: `${ScriptExecution.progress}%` }} />
          </div>
